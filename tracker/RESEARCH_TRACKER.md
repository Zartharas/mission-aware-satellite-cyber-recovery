...
| WP5 | Deterministic event library | **In progress** | E1 unauthorized-valid-command and E2 byte-identical replay delivery validated in the accepted nominal NOS3 runtime; E3 adapter next |
