...
- [ ] Execute and review the separate fail-closed v2 static gate under D-063, binding any PASS to the exact generator and candidate hashes; runtime remains unauthorized
...
D-060 (2026-07-28) accepted the historical passive time-witness static baseline; D-061 (2026-07-28) accepted the bounded runtime-control design; and D-062 (2026-07-29) accepted the versioned v2 implementation only. Contract 0.4.8 records the deterministic generator and candidate hashes and the frozen 70-second observation, but the v2 static gate remains PENDING and runtime authorization remains false with zero attempts. D-063 must separately execute and govern the fail-closed v2 static gate, and D-064 remains the sole disposition that may consider exactly one bounded passive telemetry attempt. The following remain blocked pending that separate D-064 authorization:
