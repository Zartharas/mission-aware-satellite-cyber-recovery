...
| WP4 | Testbed selection and architecture | In progress | VR14 was independently reviewed, published through PR #16, and merged at `080e487fa079...` with tree `2876303575be...`. The corrected verifier `e803d59b0a0a...` passed focused T062/T063 controls and full selftest 78/0/0 and has 0 production executions. Execution #9 remains consumed and invalid with no candidate static disposition and must not be rerun. Aggregate complete production verifier executions remain 9; candidate failure=false; static=PENDING. VR15 grants exactly one future production static-verifier attempt #10 against unchanged candidate `599c534df37b...`; the authorization is initially unconsumed and must be independently reviewed and published before use. Candidate execution, materialization, Docker/NOS3/Fortytwo, event injection, runtime, D-064, and WP5 execution remain unauthorized/blocked. | Independently review and publish the exact four-file VR15 one-run static-verifier authorization before execution #10; no runtime authorization |
