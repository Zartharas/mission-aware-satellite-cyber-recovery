...
| WP5 | Deterministic event library | **In progress** | Evidence map, event catalog, deterministic materializer, tests, and E1 delivery validated in the accepted nominal NOS3 runtime; E2 adapter next |
