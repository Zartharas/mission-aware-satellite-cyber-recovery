...
| WP4 | Testbed selection and architecture | In progress | V4 source implementation and static-verifier Execution #11 are published; successor host evidence `af8bd76dbe81004e58abd0936f7480e371db9c09b149f0529a6f658aee106669` was created under the dedicated UID, passed independent review with zero findings, and is locally bound in HE1 contract `0.4.16`; authorized root UID 599/mode 0700/ACL0 and search-only repository traversal are retained; the accepted `com.apple.provenance` finding remains documented without causation or semantic claims; D-064 and runtime remain unauthorized. | Independently review the exact seven-path HE1 publication package, then stage and publish it before any separate D-064 authorization decision |
