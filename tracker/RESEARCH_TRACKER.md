...
| WP9 | Frozen experiment campaign | **Campaign-safe route adapter validation pending** | R-057 E2 and R-059 E4 runtime route families closed; R-060 E1/A01–A09 observation binding closed; R-061 E1 bounded runtime validation closed at harness commit `9302a6bfb3daf10bcd2ff73e5a8ed8e0b55daa7a`, exact-SHA CI `32608764570`, 8/8 harness tests, full 445-test suite, and five valid retained X01–X05 runs covering P1→P1, P2→P2, P7→P1, P7→P2, and P7→P4 with treatment fidelity, 30-second observation, oracle separation, and residue-free cleanup; zero campaign seeds/data; 24×30=720 planned valid executions; next: separate E3/A10–A18 route-adapter gate; final campaign remains separately unauthorized |
