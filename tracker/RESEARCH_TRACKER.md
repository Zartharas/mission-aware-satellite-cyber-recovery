...
| WP4 | Testbed selection and architecture | In progress | VR10 R6 was independently reviewed, published through PR #12, and merged at `28fdc6b6ffcc...` with tree `0e0c879e9a77...`; corrected verifier `46cf958d3bdd...` passed selftest 78/0/0 and has 0 production executions. Execution #7 remains consumed and invalid with no candidate static disposition. VR11 reconciles the published VR10 identities and grants exactly one future corrected-verifier production static-verifier attempt against unchanged candidate `599c534df37b...`; authorization is not consumed in this gate. Aggregate complete production verifier executions remain 7; candidate failure remains false; static verification remains PENDING. Candidate execution, materialization, Docker/NOS3/Fortytwo, event injection, runtime, D-064, and WP5 execution remain unauthorized/blocked. | Independently review and publish the exact four-file VR11 one-run static-verifier authorization before execution #8; no runtime authorization |
