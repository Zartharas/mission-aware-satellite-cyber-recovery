...
`RESEARCH_TRACKER.md` is a detailed chronological research-history record. It intentionally contains stage-local statements that were correct when written and should not be treated as the live publication-state authority.

For current publication status and next-work sequencing, read these first:
...
- Canonical handoff: `publication/Paper_4_Study_8/POST_REJECTION_RESUBMISSION_HANDOFF_2026-09-19.md`.
- No fallback venue is automatically selected.
