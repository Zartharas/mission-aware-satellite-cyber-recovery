...
| Study 3 | `S3-K4E-001`, 1,380 trajectories / 67,620 epochs | Study 2 does not model one-shot/persistent false evidence across repeated K4 contact transitions | canonical results merged in PR #79 / `68a2c9a1394743e9a233e93586e86a6179a0793c`; independent audit PASS | Paper 2 with Studies 4 + 6; submitted to TAES |
| Study 4 | `S4-MPQ-001`, 4,608 exact observations | Study 3 has a single evidence-producer trust boundary and cannot quantify quorum/provenance-diversity trade-offs | canonical results merged in PR #81 / `09a3fa61276e348b58a852c156e7bfc64b25d32d`; independent audit PASS, 0 observation and 0 threshold mismatches | Paper 2 with Studies 3 + 6; submitted to TAES |
...
| Study 6 | `S6-SCTR-001`, 420 exact observations | Studies 2-4 trust the recovery artifact itself; Study 6 moves the trust boundary upstream to artifact qualification | canonical results merged in PR #85 / `0dfe7f4331fc1f8864344c95d39e0d8dcb74c8f4`; independent audit PASS | Paper 2 with Studies 3 + 4; submitted to TAES |
| Study 7 | `S7-LSO-001`, 1,033 exact observations | Earlier selectors are deterministic rule-based mechanisms and cannot answer whether a learned selector over the same visible information can escape the V5 information boundary | canonical results merged in PR #87 / `f582c36cc5747a6703ec651bb957bbfea5852a7e`; independent audit PASS | Paper 3; submitted to CEAS Space Journal |
| Study 8 | `S8-PQC-ICR-001`, 3,456 canonical + 3,456 independently reproduced rows, 0 mismatches | Earlier studies do not model cryptographic-transition byte burden and finite intermittent-contact recovery budgets | science closed; source publication package frozen; Acta package submitted | roadmap Paper 4; Acta manuscript `AA-D-26-02872`, rejected by editorial decision recorded 2026-09-19; controlled retarget audit required |
...
Paper 2 is no longer a candidate-development item. Keep its three frozen populations separate and do not modify the submitted package unless TAES requests a correction or revision.
...
**Submitted venue:** CEAS Space Journal  
**Submission date:** 2026-09-13  
**Submission ID:** `6db04a31-8223-4aaf-af02-e4bafe06ef89`  
**Current state:** `SUBMITTED__TECHNICAL_CHECK`

Paper 3 is no longer a candidate-development item. Keep Study 7 frozen and do not alter the submitted CEAS package unless the journal requests a correction or revision.
...
The Acta editorial decision was recorded on 2026-09-19. No external reviewer reports were supplied and no specific methodological, statistical, reproducibility, ethics, data, or scope defect was enumerated. The rejected Acta package remains immutable provenance.

The post-rejection forensic audit found no demonstrated defect in the frozen Study 8 science. The live venue review recommends **International Journal of Satellite Communications and Networking** as the strongest topical fit, with **IEEE Systems Journal** as the systems-oriented fallback. This recommendation is not a venue lock.
...
The immediate gate is explicit author approval of the target venue, followed by a controlled derivative manuscript rebuild from frozen Study 8 evidence. No scientific reexecution or statistical reanalysis is authorized by the rejection or retarget plan.
...
## Publication-order recommendation from 2026-09-19

1. Keep Paper 1 frozen while JAIS editorial/peer review proceeds.
2. Keep Paper 2 frozen while TAES editorial processing proceeds.
3. Keep Paper 3 frozen while CEAS technical/editorial processing proceeds.
4. Make Paper 4 / Study 8 venue-lock approval and controlled manuscript rebuild the immediate active publication-development gate.
5. Use the completed forensic audit, live venue shortlist, and rebuild plan as the retarget authority; do not repeat the completed audit unless new evidence warrants it.
6. Do not rerun or reanalyze Study 8 merely to improve publication prospects. If a genuine scientific defect is demonstrated, stop and obtain separate authorization before reopening science.
7. Defer Study 5 and other remaining-candidate publication work until the Paper 4 retarget decision unless the author explicitly reprioritizes it.
