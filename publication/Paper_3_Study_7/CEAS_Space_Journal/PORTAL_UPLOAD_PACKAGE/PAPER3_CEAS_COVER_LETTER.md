...
The manuscript addresses a space-systems assurance question at the intersection of cybersecurity and artificial intelligence in space: whether a learned satellite cyber-recovery selector can make an adjudicated-correct decision when trusted-looking recovery evidence may itself be false, and how that boundary changes when corroborating evidence is independently informative versus correlated with the compromised path. This aligns directly with the journal’s coverage of space systems, cybersecurity for space systems, and artificial intelligence in space.
