...
The Study-7 protocol, canonical result records, policy summary, and separately implemented audit materials are publicly available in the mission-aware-satellite-cyber-recovery repository at https://github.com/Zartharas/mission-aware-satellite-cyber-recovery. The accepted execution is identified by workflow run 33689625480 and commit f1530b0b2e81a5916adaf7ce808075156424dfb5; frozen SHA-256 identities are recorded in study7/results/RESULTS_FREEZE.json. The accepted output artifact is hash-bound and a permanent archival deposit of the exact accepted bytes is planned before publication. No confidential, proprietary, or human-subject data are used.
...
The manuscript currently points to the public GitHub repository and frozen execution identity. The project-level submission gate still requires a durable archive of the exact accepted Study-7 bytes before final publisher submission. If a DOI is minted, update the Data Availability statement and reference list before final upload, then regenerate manuscript hashes.
