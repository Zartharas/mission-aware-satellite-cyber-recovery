...
- [ ] Approve the final concise abstract if the live journal guide makes a shorter version preferable or necessary.
...
- [ ] Confirm the live Computers & Security guide has no journal-specific exception before submission.

## Release/export gate

Do not submit until every unchecked author-attestation item above is explicitly resolved. Formatting and portal-only items may be completed after those attestations, but scientific quantities and the frozen evidence boundary must not be changed merely to satisfy presentation requirements.
