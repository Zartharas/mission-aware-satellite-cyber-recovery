...
The Study-1 raw campaign and integrity package are publicly archived on Zenodo (version DOI **10.5281/zenodo.22181540**; concept DOI **10.5281/zenodo.22181539**). That record is explicitly the Study-1 evidence-of-record. The separately frozen Study-2 Phase-6 source-evidence package is also publicly archived on Zenodo as version **1.0.0** (version DOI **10.5281/zenodo.22289114**; concept DOI **10.5281/zenodo.22289113**). The publicly served Study-2 ZIP was independently re-downloaded after publication and its SHA-256 exactly matched the frozen source-evidence identity. The Study-2 Phase-7 statistical result artifact and cryptographic provenance remain retained in the public repository.
