...
| Submission exclusivity | Paper must not be submitted elsewhere | Confirmed |
| Classification/public release | Submission requires unclassified/public-release attestation | Unclassified; no external classification review required |
| Author verification | Author verification required before submission is complete | Sole-author verification applies; exact workflow pending |
| Suggested reviewers | Names/contact information supplied as requested | Exact number/required status pending |
...
5. Exact subject-area/classification taxonomy and number of selections.
6. Exact affiliation/postal-code fields required for an Independent Researcher affiliation.
7. Exact author-verification steps for a sole-author submission.
8. Exact funding question wording and how a no-funding answer is entered.
9. Exact conflict-of-interest/declaration wording.
10. Exact artificial-intelligence disclosure question and response field.
11. Exact number and required/optional status of suggested reviewers.
12. Exact reviewer-exclusion fields, if present.
13. Exact ethics/human-subject/institutional-review questions, if present.
14. Exact data/code availability questions, if present.
15. Exact prior-publication, preprint, dissertation, or related-manuscript questions, if present.
16. Exact file designations available for manuscript, title page, figures, tables, supplemental material, cover letter, and other items.
17. Exact copyright, originality, clearance, and public-release attestations shown before completion.
18. Exact editor, associate-editor, special-issue, or topical-track selection fields, if present.
19. Any page-charge/open-access choice presented before final submission.
20. Final proof/preview behavior and generated submission PDF checks.
...
Do not enter an institutional-review identifier, grant number, reviewer identity, conflict, classification authority, postal code, or other factual value unless it is actually supported by the research record or supplied/approved by the author.
