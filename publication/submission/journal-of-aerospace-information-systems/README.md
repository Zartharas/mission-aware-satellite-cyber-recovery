...
**Branch base:** `86a5a266633e707fa1c700098683cb15818dd415`

## Scientific boundary

This target switch is editorial only. It does not reopen or alter the frozen science.

- Study 1 remains 720 VALID observations across 24 frozen cells.
- Study 2 remains 3,872 VALID observations across 85 frozen cells with 0 INVALID attempts.
- Study 1 and Study 2 remain separate statistical populations and are not pooled.
- No new experimental execution is authorized for Paper 1.
...
Publication preparation may change venue-facing wording, formatting, ordering, reference style, abstract length, cover-letter framing, declarations placement, and portal metadata. It may not create new science, change frozen statistical results, weaken limitations, import Study 8, or represent software-in-the-loop evidence as operational flight validation.
