...
The four contact regimes were deliberately normalized to the same 65,536 nominal bytes over the full 48-slot cycle. Their different success proportions therefore isolate the temporal distribution of capacity within the frozen abstraction. R4's clustered structure was notably less favorable than the other regimes in the prespecified P1/P3 comparison, while R1 and R2 performed similarly despite different contact granularity.
