...
Raw campaign evidence remains outside GitHub. A DOI-bearing archive deposit is planned through the responsible-artifact-release phase; until that deposit is complete, the repository records cryptographic identities and aggregate publication artifacts without claiming that the full raw campaign is publicly downloadable.
