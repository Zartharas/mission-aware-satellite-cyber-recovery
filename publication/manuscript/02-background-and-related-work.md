...
The idea that cyber risk can vary with mission or time is also active prior art. Recent temporal-risk research explicitly models how the same satellite vulnerability may have different consequences across operationally meaningful mission windows [@liu2026temporal]. The present study therefore does not claim that time- or mission-sensitive cybersecurity is new.
