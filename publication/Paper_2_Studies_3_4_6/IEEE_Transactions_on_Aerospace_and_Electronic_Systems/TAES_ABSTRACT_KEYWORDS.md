...
**Verified word count using repository assembly tokenizer:** 214 words.
...
- The V4 claim is limited to the affected manipulated records; ordinary pre-onset cache exposure remains separately acknowledged.
